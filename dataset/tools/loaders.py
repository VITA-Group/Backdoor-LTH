...
from dataset.tools import folder
...
def make_loaders(workers, batch_size, transforms, data_path, data_aug=True,
    ...
    **INTERNAL FUNCTION**
    ...
    if not custom_class:
        ...
        print('Poison train dataset and clean test dataset')
        if not only_val:
    ...
    if not only_val:
        ...
        train_loader = DataLoader(train_set, batch_size=batch_size, 
            shuffle=(train_sampler is None), num_workers=workers, pin_memory=True, sampler=train_sampler)
